...
module.exports = async (params) => {
    ...
    await checkApprove(wallet, usdc.address, draculafi.routerAddr, usdcBalance);

    tx = await draculafi.swapTokenToEth(wallet, usdc.address, wETH.address, usdcBalance, min=ethers.BigNumber.from(0));
