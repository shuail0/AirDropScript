...
const TenKSwap = require('../protocol/starknet/dex/10kswap/10kswap.js');
...
module.exports = async (params) => {
    ...
    // // 交易
    let tx = await tenkswap.swapTokenToToken(account, tokenA.address, tokenB.address, swapAmount);
    ...
    // 将tokenB换成TokenA
    tx = await tenkswap.swapTokenToToken(account, tokenB.address, tokenA.address, tokenBalance);
