...
module.exports = async (params) => {
    ...
    console.log(
        "poolToken余额：",
        fixedToFloat(poolTokenBalance),
        "开始授权tarotrouter合约使用poolToken"
    );

    // 授权tarotrouter合约使用poolToken
    await tokenApprove(wallet, poolToken, tarot.routerAddr, poolTokenBalance);
