...
module.exports = async (params) => {
    ...
    // // 交易
    let tx = await avnu.swapTokenToToken(account, tokenA.address, tokenB.address, swapAmount);
    ...
    // 将tokenB换成TokenA
    tx = await avnu.swapTokenToToken(account, tokenB.address, tokenA.address, tokenBalance);
