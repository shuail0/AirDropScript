...
const StarkEx = require('../protocol/starknet/dex/starkex/starkex.js');
...
module.exports = async (params) => {
    ...
    // // 交易
    let tx = await starkex.swapTokenToToken(account, tokenA.address, tokenB.address, swapAmount);
    ...
    // 将tokenB换成TokenA
    tx = await starkex.swapTokenToToken(account, tokenB.address, tokenA.address, tokenBalance);
