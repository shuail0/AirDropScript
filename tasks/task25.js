...
module.exports = async (params) => {
    ...
    await checkApprove(wallet, usdc.address, vesyncswap.routerAddr, usdcAmount);
        

    tx = await vesyncswap.swapTokenToEth(wallet, usdc.address, wETH.address, usdcAmount, min=ethers.BigNumber.from(0));
